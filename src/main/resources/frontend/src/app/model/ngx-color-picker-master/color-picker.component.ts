...
@Component({
  ...
  styleUrls: [ './color-picker-cus.component.css' ],
...
export class ColorPickerComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  public onMouseDown(event: MouseEvent): void {
   ...
   public onRemoveColor(event: Event) {
    this.hexText = this.hexTextOld;
    event.stopPropagation();
    if (this.outputColor) {
      this.onHexInput(this.lastColor);
      this.selectedColor = this.hexTextOld;
      this.outputColor = '';
  ...
  private openColorPicker(): void {
    if (!this.show) {
      this.lastColor = this.outputColor;
      this.show = true;
      this.hidden = true;
